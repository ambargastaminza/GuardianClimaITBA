...
def mostrar_info_aplicacion():
    ...
    print("\n¿Cómo se usa?")
    print("FUNCIONALIDADES DEL MENÚ:")
    print("- Registro de usuario: permite crear una cuenta con validación de contraseña segura.")
    print("- Login: accede al sistema con usuario y contraseña.")
    print("- Consulta del clima: muestra información climática actual de una ciudad.")
    print("- Ver historial: muestra las consultas anteriores del usuario.")
    print("- Estadísticas globales: resume la actividad total del sistema.")
    print("- Consejo IA: brinda una recomendación basada en el clima actual.")
    print("- Cerrar sesión: vuelve al menú de acceso.\n")

    print("FUNCIONAMIENTO INTERNO:")
    print("• El registro de usuarios simula un sistema real, exigiendo contraseñas seguras.")
    print("  Se valida que tengan al menos 8 caracteres, incluyendo mayúsculas, minúsculas, números y símbolos.")
    print("  Si la contraseña es débil, se rechaza e indica cómo mejorarla.")
    print("• Las credenciales se almacenan en texto plano dentro de un archivo CSV, lo cual NO es seguro.")
    print("  En un sistema real, deberían cifrarse usando técnicas como hash (por ejemplo, bcrypt o SHA256).\n")

    print("• La aplicación obtiene datos del clima usando una API externa.")
    print("  Cada consulta se guarda en un archivo 'historial.csv', lo que permite al usuario llevar un registro.")
    print("• Se generan estadísticas a partir del historial global, como la ciudad más consultada")
    print("  o el tipo de clima más frecuente, y se preparan datos en CSV para posibles gráficos o visualizaciones.")
    print("• Además, la app incluye una interacción con un módulo de IA que brinda consejos útiles en función")
    print("  del clima actual, ayudando a tomar decisiones cotidianas (por ejemplo: llevar paraguas, abrigarse, etc.)\n")
    print("\nVersión: 1.0")
    print("Fecha: Junio 2025")
    print("\n🫂 Equipo de desarrollo:")
    print("IAQ (Inteligencia Ambiental de Calidad)🧬")
    print("\n🙋 Desarrolladores:")
    print("- Barbás Delfina\n- Gastaminza Ámbar\n- Lee Angulo Osmary\n- López Antolin María\n- Saldivia Ramiro")
    print("\nRepositorio: github.com/usuario/GuardianClimaITBA\n")
